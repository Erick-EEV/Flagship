...
class ChatroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chatroom" do
    assert_difference('Chatroom.count') do
      post chatrooms_url, params: { chatroom: { server_id: @chatroom.server_id, title: @chatroom.title } }, as: :json
    end
  ...
  test "should update chatroom" do
    patch chatroom_url(@chatroom), params: { chatroom: { server_id: @chatroom.server_id, title: @chatroom.title } }, as: :json
    assert_response 200
  end
